                    ...
                    <div class="signup-form">
                        ...
                        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" class="register-form" id="register-form">
                            ...
                            <div class="form-group <?php echo (!empty($password_err)) ? 'has-error' : ''; ?>">
                                ...
                                <input type="password" name="password" id="pass" value="<?php echo $password; ?> placeholder="Password"/>
                            </div>
                            <div class="form-group <?php echo (!empty($confirm_password_err)) ? 'has-error' : ''; ?>">
                                <label for="re-pass"><i class="zmdi zmdi-lock-outline"></i></label>
                                <input type="password" name="confirm_password" id="re_pass" value="<?php echo $confirm_password; ?> placeholder="Repeat your password"/>
                            </div>
